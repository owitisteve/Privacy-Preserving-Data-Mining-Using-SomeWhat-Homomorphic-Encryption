...
$user_id = $_SESSION['counselee_id']; // Replace with the actual user ID
...
if (isset($_GET['mark_as_read'])) {
    ...
    header("Location: trials.php"); // Reload the page after marking as read
    exit();
}
?>
    ...
    <?php foreach ($notifications as $notification): ?>
        <?php if (!$notification['is_read']): ?>
            <li class="notification-item">
                <form method="GET" action="counseleehelp.php" style="margin: 0;">
